...
namespace Tinifier.Core.Infrastructure
{
    class PackageConstants
    {
        ...
        public const string ApiKeyNotFound = "You don`t have ApiKey in settings! Please, go to <a href=\"/umbraco/#/tinifier\" target=\"_blank\">tinifier</a> section and add ApiKey there!";
